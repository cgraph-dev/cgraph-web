...
| --------------------------------------------------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Cloud DM creation/opening                           | Partial | `apps/web/src/pages/messages/messages/messages.tsx` handles `?userId=` and can create/select a cloud conversation, and the opened route now renders through shared `modules/chat/components/conversation-surface.tsx` for the stable header/message-scroll/composer/floating-control/request/pinned/modal slots. The Cloud Chat route still owns backend data/action slot composition, so this is not yet one end-to-end conversation owner. The live composer, message list, and bubble/action/media stack now flow through shared `modules/chat` adapters.                                                                                                                                                                                                                                                                                                                                                                                                      |
