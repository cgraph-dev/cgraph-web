...
3. Routed DM parity
   - Keep the browser-verified typing emit green while finishing GIF/sticker and call-flow parity.
...
Equal-weight release-readiness score: `45.7%`.
