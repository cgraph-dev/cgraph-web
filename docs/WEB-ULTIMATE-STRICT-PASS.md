...
- Nodes false-success handling is now materially fixed in targeted tests; routed wallet/shop browser
  ...
  insufficient-balance, already-unlocked, and rate-limit failure states. Routed forum content unlock
  proof now covers insufficient balance, not-gated, not-found, explicit failure, and retry-to-success
  without false-success UI. Stripe handoff success and final broad validation remain open.
...
- Nodes wallet, shop, tip, gift, unlock, and checkout now throw or render explicit failure states in
  ...
  Routed browser proof now covers profile tip/gift and forum content-unlock retry behavior as well.
...
Equal-weight release-readiness score: `74.0%`.
...
- [x] Recheck insufficient-balance, already-unlocked, self-gift, rate-limit, and remaining negative
      ...
      `apps/web/e2e/dm-media-composer.spec.ts`. Later routed proof closes profile tip/gift and
      forum content-unlock retry UX; remaining release risk moves to Stripe handoff success and
      broad final regression.
