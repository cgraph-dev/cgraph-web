...
| Phase                                            | Score | Why                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| ------------------------------------------------ | ----- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Messaging contract convergence                   | `73%` | Routed DM and group file/photo sends now use the same shared upload-first metadata contract from `packages/shared-types/src/media.ts`; both routed browser proofs are green, the unused alternate media-upload owner was removed, and the routed Cloud Chat composer now consumes the shared `modules/chat` `MessageInput` contract for text, files, paid-file pricing, GIFs, stickers, voice notes, draft ownership, and typing events. Remaining convergence work is the broader routed message list/action/bubble/media surface.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| Routed DM parity                                 | `85%` | Basic DM open/send, browser-verified typing emit, stable guarded search anchors, jump-to-latest behavior, mark-as-read, browser-verified read-receipt rendering, browser-verified file/photo, voice-note, GIF, and sticker send, browser-verified DM call-entry launch, routed reply/search jump/edit/delete/forward/request/pin/pinned-panel behavior, incoming-call accept/end-call route proof, browser-verified sidebar mark unread/read, pin/unpin, mute/unmute, archive/recover, and Space add/remove are now wired. The live Cloud Chat composer now routes through the shared `modules/chat` composer contract and is reverified by the full routed DM media/composer browser spec. Remaining gaps are canonical surface convergence beyond the composer, deeper media-negotiation proof, and broader final browser verification.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
Equal-weight release-readiness score: `71.0%`.
...
- [ ] Move the routed cloud-DM page onto the shared `modules/chat` conversation surface, or port the
      ...
      2026-05-25 progress: the routed Cloud Chat composer now uses the shared `MessageInput`
      adapter for text, files, paid-file pricing, GIFs, stickers, voice notes, draft ownership, and
      typing events. Focused component tests and the full routed
      `apps/web/e2e/dm-media-composer.spec.ts` browser proof are green. This row stays open until
      the broader message list/action/bubble/media surface converges too.
