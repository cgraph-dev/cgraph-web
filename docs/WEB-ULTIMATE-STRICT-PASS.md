...
Equal-weight release-readiness score: `69.3%`.
...
- [ ] Finish non-pin group permission-edge proof, stronger group scroll behavior, and deeper role
      CRUD/reorder. Channel-level notification semantics, backend older-history channel search, and
      pinned-message 403 contracts are now browser-verified through the routed group page.
