...
10. The richer module-level group-admin stack is now mounted from the live groups route via
    ...
    states, stronger scroll/search proof, role CRUD/reorder proof, and channel-level notification
    semantics.
...
Equal-weight release-readiness score: `68.7%`.
