...
- cloud DMs still keep a route-local page/list owner, though the live composer plus
...
1. DMs and groups are closer to one authoritative chat surface, but not fully there. The routed DM
   composer and message bubble/action/media rendering now use shared `modules/chat` adapters, while
   the routed page/list orchestration still lives in
...
| --------------------------------------------------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Cloud DM creation/opening                           | Partial | `apps/web/src/pages/messages/messages/messages.tsx` handles `?userId=` and can create/select a cloud conversation, but the opened route still keeps route-local page/list orchestration instead of using one shared conversation surface end to end.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
Equal-weight release-readiness score: `71.4%`.

Truthful rounded Goal 2 completion: `71%`.
...
- [ ] Move the routed cloud-DM page onto the shared `modules/chat` conversation surface, or port the
      ...
      action menu for the routed DM proof. This row stays open until the route-owned message
      list/page orchestration converges too.
