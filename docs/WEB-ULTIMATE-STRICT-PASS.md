...
| Call launch coverage                                | Partial | The manual `/call/:recipientId/:callType` route and routed DM header launch are browser-verified, and call-history callback exists. History callback, incoming call, media negotiation, and end-state behavior are not yet fully browser-verified route-owned end-to-end in this pass.                                                                                                                                                                                                                                                        |
...
Equal-weight release-readiness score: `45.9%`.
...
- [ ] Browser-verify history-based call entry, incoming-call flow, and full media/end-state
      behavior.
...
- [ ] Verify call-history callback, incoming-call flow, and full media/end-state behavior.
