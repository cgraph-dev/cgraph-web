...
9. Group voice, stickers, GIFs, and stronger routed scroll behavior are now browser-verified on
   the routed page. Remaining group risk is richer admin edge-state breadth.
...
Equal-weight release-readiness score: `70.8%`.
...
- [x] Finish stronger group scroll behavior. Closed on 2026-05-25 by constraining the routed group
      shell height, replacing naive message-list autoscroll with guarded latest-anchor behavior,
      and browser-verifying routed anchors, incoming-message stability, and jump-to-latest behavior
      in `apps/web/e2e/group-channel-scroll.spec.ts`.
