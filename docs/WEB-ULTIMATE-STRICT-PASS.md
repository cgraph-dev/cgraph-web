...
- [ ] Finish the remaining non-pin group permission-edge proof and stronger group scroll behavior.
      Channel-level notification semantics, backend older-history channel search, pinned-message
      403 contracts, role CRUD/reorder contracts, overview-save 403 copy, role create/reorder 403
      copy, invite-create 403 copy, and member-role-assignment 403 copy are now browser-verified
      through the routed group page. Invite list/delete 403, role update/delete 403, kick/ban/mute
