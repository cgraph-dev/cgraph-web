...
| Feature                               | Availability          | User note                                                                                                                                                                                                                                                                                                     |
| ------------------------------------- | --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Email login and registration          | `Web partial`         | Core routed flows exist, expired verification links can request a new email while logged out, onboarding skip persists through the backend, and focused UAT verifies the login route renders. Full end-to-end auth, recovery, 2FA, mail-provider, gate-order, and edge-state verification remains incomplete. |
