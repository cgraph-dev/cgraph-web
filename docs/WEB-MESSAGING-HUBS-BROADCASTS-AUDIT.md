...
| Open pinned messages list                | Partial | `pinned-messages-panel.tsx` can fetch and unpin pins, and the live message menu can create pins through the channel pins endpoint. Pin creation is browser-verified; pinned-panel unpin and permission-denied states remain open.                                                    | Browser-verify unpin and permission-denied states.                                |
