...
describe('identity contract', () => {
  ...
  it('falls back to offline for unknown identity statuses', () => {
    expect(normalizeIdentityStatus('online')).toBe('online');
    expect(normalizeIdentityStatus('lunch')).toBe('offline');
    expect(normalizeIdentityStatus(null)).toBe('offline');
  });
});
