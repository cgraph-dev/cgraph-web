...
/** Maps backend settings JSON into the shared client settings shape. */
export function settingsFromApi(data: ApiSettings): UserSettings {
...
/** Maps shared client settings into backend snake_case settings JSON. */
export function settingsToApi(settings: Partial<UserSettings>): Record<string, unknown> {
...
/** Narrows raw realtime settings payloads into a typed backend settings payload. */
export function narrowApiSettings(raw: Record<string, unknown>): ApiSettings {
